                ...
                if (c % timeF == 0):
                    ...
                    if nrof_faces > 0:
                        ...
                        for i in range(nrof_faces):
                            ...
                            print(result_names)
                            if best_class_probabilities[0] > 0.23 and result_names != 'R99999 Unk':
                                ...
                                result_names = class_names[best_class_indices[0]]
                                print(result_names)
                                cv2.putText(frame, result_names.split(' ')[1], (text_x, text_y),
                                            cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255),
                                            thickness=1, lineType=2)

                            elif best_class_probabilities[0] > 0.060:
